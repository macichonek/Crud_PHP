...
try{
    ...
    while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo"<table border= '1'><tr><td>$linha[nome]</td><td>$linha[login]</td><td><a href='formEditar.php?id=$linha[id]'>Editar</a> - <a href='excluir.php?id=$linha[id]'>Excluir</a></td></tr>";
